    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefones', models.CharField(max_length=60, null=True, verbose_name='Telefone', blank=True)),
                ('celulares', models.CharField(max_length=60, null=True, verbose_name='Celular', blank=True)),
        ...
        migrations.AddField(
            model_name='pedidoitem',
            name='setor',
            field=models.ForeignKey(to='base.Setor'),
        ),
        migrations.AddField(
            model_name='pedidoitem',
            name='solicitacao',
