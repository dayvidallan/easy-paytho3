...
class Pregao(models.Model):
    ...
    data_inicio = models.DateField(u'Data de Início da Retirada do Edital', null=True)
    data_termino = models.DateField(u'Data de Término da Retirada do Edial', null=True)
    data_abertura = models.DateField(u'Data de Abertura do Certame', null=True)
    hora_abertura = models.TimeField(u'Hora de Abertura do Certame', null=True)
